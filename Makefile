...
qpu_memcpy_3.o: qpu_memcpy_3.qhex
...
clean:
	$(RM) main main.o
	$(RM) qpu_memcpy.o cpu_memcpy_1.o cpu_memcpy_2.o cpu_memcpy_3.o qpu_memcpy_1.o qpu_memcpy_2.o qpu_memcpy_3.o
	$(RM) qpu_memcpy_1.qhex qpu_memcpy_1.qbin qpu_memcpy_1.qasm2
	$(RM) qpu_memcpy_2.qhex qpu_memcpy_2.qbin qpu_memcpy_2.qasm2
	$(RM) qpu_memcpy_3.qhex qpu_memcpy_3.qbin qpu_memcpy_3.qasm2
